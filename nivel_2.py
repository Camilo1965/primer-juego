    ...
    for event in pygame.event.get():
        ...
        if game_active:        
            if event.type == obstacle_timer:
                if randint(0,2):
                            obstacle_rect_list.append(enemy_surface.get_rect(midbottom = (randint(700,1700),600)))
                else: obstacle_rect_list.append(enemy_surface2.get_rect(midbottom = (randint(1000,2000),400)))
